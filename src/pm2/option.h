...
public:
  ...
  ListOption() : list_(nullptr) {}
  virtual bool do_opt(alpm_handle_t *) = 0;
  virtual alpm_list_t *getList() { return list_; }
...
public:
  explicit HookDirsOpt(string str) : ListOption(str) {}
  HookDirsOpt() : ListOption() {}
...
public:
  explicit CacheDirsOpt(string str) : ListOption(str) {}
  CacheDirsOpt() : ListOption() {}
...
public:
  explicit NoExtractsOpt(string str) : ListOption(str) {}
  NoExtractsOpt() : ListOption() {}
...
public:
  explicit NoUpgradesOpt(string str) : ListOption(str) {}
  NoUpgradesOpt() : ListOption() {}
...
public:
  explicit IgnorePkgsOpt(string str) : ListOption(str) {}
  IgnorePkgsOpt() : ListOption() {}
...
public:
  explicit IgnoreGrpOpt(string str) : ListOption(str) {}
  IgnoreGrpOpt() : ListOption() {}
  virtual bool do_opt(alpm_handle_t *handle) override {
...
public:
  ...
  virtual bool do_opt(alpm_handle_t *) override { return true; }
  virtual int get_id() override { return OPTID; }
  virtual ~StrOption() {}
};
...
public:
  explicit NameOpt(string str) : StrOption(str) {}

  virtual bool do_opt(alpm_handle_t *handle) override { return true; }
...
public:
  explicit LogFileOpt(string str) : StrOption(str) {}
...
public:
  explicit ArchOpt(string str) : StrOption(str) {}
  virtual bool do_opt(alpm_handle_t *handle) override {
    char *_str = (char *)malloc(value_.size());
    strncpy(_str, value_.c_str(), value_.size());
...
public:
  explicit GPGDirOpt(string str) : StrOption(str) {}
  virtual bool do_opt(alpm_handle_t *handle) override {
    char *_str = (char *)malloc(value_.size());
    strncpy(_str, value_.c_str(), value_.size());
...
public:
  explicit NoteOpt(string str) : StrOption(str) {}
  virtual bool do_opt(alpm_handle_t *handle) override {
    // TODO
    return true;
  }
...
public:
  explicit RootDirOpt(string str) : StrOption(str) {}
  virtual bool do_opt(alpm_handle_t *handle) override { return true; }
...
public:
  explicit DBPathOpt(string str) : StrOption(str) {}
  virtual bool do_opt(alpm_handle_t *handle) override { return true; }
