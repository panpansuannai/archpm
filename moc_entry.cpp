...
QT_MOC_LITERAL(1, 6, 14), // "sig_remove_pkg"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 6), // "entry*"
QT_MOC_LITERAL(4, 29, 15), // "sig_install_pkg"
QT_MOC_LITERAL(5, 45, 13), // "show_pkg_info"
QT_MOC_LITERAL(6, 59, 11), // "install_pkg"
QT_MOC_LITERAL(7, 71, 10) // "remove_pkg"

    },
    "entry\0sig_remove_pkg\0\0entry*\0"
    "sig_install_pkg\0show_pkg_info\0install_pkg\0"
    "remove_pkg"
};
...
void entry::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sig_remove_pkg((*reinterpret_cast< entry*(*)>(_a[1]))); break;
        case 1: _t->sig_install_pkg(); break;
        case 2: _t->show_pkg_info(); break;
        case 3: _t->install_pkg(); break;
        case 4: _t->remove_pkg(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&entry::sig_remove_pkg)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (entry::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&entry::sig_install_pkg)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void entry::sig_remove_pkg(entry * _t1)
{
